...
impl AsyncTradernet {
    ...
    /// Returns normalized candle series for a symbol.
    pub async fn get_candles_series(
        &self,
        symbol: &str,
        start: NaiveDateTime,
        end: NaiveDateTime,
    ...
    /// Returns normalized candle series for a symbol with explicit `count`.
    pub async fn get_candles_with_count_series(
        &self,
        symbol: &str,
        start: NaiveDateTime,
        end: NaiveDateTime,
        ...
        let response = self
            .get_candles_with_count_typed(symbol, start, end, timeframe_seconds, count)
            .await?;
    ...
    /// Returns typed trade history.
    #[allow(clippy::too_many_arguments)]
    pub async fn get_trades_history_typed(
        &self,
        start: NaiveDate,
        end: NaiveDate,
        trade_id: Option<i64>,
    ...
    /// Returns trade history with optional reception (office id) filter.
    #[allow(clippy::too_many_arguments)]
    pub async fn get_trades_history_with_reception(
        &self,
        start: NaiveDate,
        end: NaiveDate,
        trade_id: Option<i64>,
    ...
    /// Returns typed trade history with optional reception (office id) filter.
    #[allow(clippy::too_many_arguments)]
    pub async fn get_trades_history_with_reception_typed(
        &self,
        start: NaiveDate,
        end: NaiveDate,
        trade_id: Option<i64>,
        ...
        let response = self
            .get_trades_history_with_reception(
                start, end, trade_id, limit, symbol, currency, reception,
            )
            .await?;
