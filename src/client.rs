...
impl Tradernet {
    ...
    /// Returns candle data for a symbol and time range with explicit `count`.
    ///
    ...
    /// Returns typed candle data for a symbol and time range.
    pub fn get_candles_typed(
        &self,
        symbol: &str,
        start: NaiveDateTime,
        end: NaiveDateTime,
    ...
    /// Returns typed candle data for a symbol and time range with explicit `count`.
    pub fn get_candles_with_count_typed(
        &self,
        symbol: &str,
        start: NaiveDateTime,
        end: NaiveDateTime,
